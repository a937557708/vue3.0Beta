...
declare type EmitFn<Options = ObjectEmitsOptions, Event extends keyof Options = keyof Options> = Options extends any[] ? (event: Options[0], ...args: any[]) => void : UnionToIntersection<{
...
export declare interface FunctionalComponent<P = {}, E extends EmitsOptions = Record<string, any>> extends ComponentInternalOptions {
...
export declare type VNodeTypes = string | Component | typeof Text_2 | typeof Static | typeof Comment_2 | typeof Fragment | typeof TeleportImpl | typeof SuspenseImpl;
