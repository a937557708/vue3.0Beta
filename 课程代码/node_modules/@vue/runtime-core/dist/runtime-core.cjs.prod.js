...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const patchElement = (n1, n2, parentComponent, parentSuspense, isSVG, optimized) => {
        ...
        const oldProps = (n1 && n1.props) || shared.EMPTY_OBJ;
    ...
    setup(props, { slots }) {
        ...
        sharedContext.deactivate = (vnode) => {
            ...
            queuePostRenderEffect(() => {
                ...
                if (component.da) {
                    shared.invokeArrayFns(component.da);
                }
...
const PublicInstanceProxyHandlers = {
    get({ _: instance }, key) {
        ...
        if (key[0] !== '$') {
            ...
            // props
            type.props &&
                shared.hasOwn(normalizePropsOptions(type)[0], key)) {
    ...
    has({ _: { data, setupState, accessCache, ctx, type, appContext } }, key) {
        return (accessCache[key] !== undefined ||
            ...
            (type.props && shared.hasOwn(normalizePropsOptions(type)[0], key)) ||
