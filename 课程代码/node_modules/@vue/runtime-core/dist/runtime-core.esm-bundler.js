import { pauseTracking, resetTracking, isRef, toRaw, isProxy, shallowReactive, trigger, effect, stop, isReactive, reactive, track, shallowReadonly, computed as computed$1, ref } from '@vue/reactivity';
...
import { isString, isFunction, isPromise, isArray, extend, isOn, camelize, capitalize, isObject, EMPTY_ARR, normalizeClass, normalizeStyle, EMPTY_OBJ, hyphenate, def, hasOwn, isReservedProp, toRawType, makeMap, NO, invokeArrayFns, NOOP, remove, hasChanged, isGloballyWhitelisted, toDisplayString } from '@vue/shared';
